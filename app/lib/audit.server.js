...
export async function loadAuditData(request) {
  ...
  const COPY_KEYS = [
    ...
    "step4FlowTitle", "step4FlowIntro", "step4PaidIntro", "billingBundleStep2", "billingBundleContinue", "billingStatusTitle",
    "billingStatusNone", "billingStatusSetupOnly", "billingStatusActive", "billingShopifyReceipt", "alreadyOptimizedTitle", "alreadyOptimizedBody",
