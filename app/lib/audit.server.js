...
export async function loadAuditData(request) {
  ...
  const COPY_KEYS = [
    ...
    "fixSeoDone", "previewAllDone", "seeUpdatedScore",
    ...
    "priorityTitle", "priorityExplain", "rank", "product", "score", "targetScore", "loading", "error", "impactIntro",
    "previewTitle", "previewSummary", "previewSchema", "previewDesc", "schemaEmbedNote", "before", "after", "seoTitle", "apply", "confirmLabel",
    "applying", "applySuccess", "applySuccessWithSchema", "applyError", "noChanges",
    "restore", "restoreAll", "restoreAllConfirm", "restoreAllSuccess", "restoring", "restoreSuccess",
    "resetTitle", "resetBody", "resetHint",
    "scoreMaxNote",
    "resultsTitle", "resultsSummary", "resultsSummarySchema", "resultsTimeline", "moreProducts",
    ...
    "expectationsTitle", "expectationsMeansTitle", "expectationsMeans1", "expectationsMeans2",
    "expectationsNotTitle", "expectationsNot1", "expectationsNot2",
    "expectationsDoneTitle", "expectationsDone1", "expectationsDone2", "expectationsDone3", "expectationsDone4",
