...
async function loadAuditDataInner(request) {
  ...
  const COPY_KEYS = [
    ...
    "generateAiPlan", "skipAiPlan", "step1AiTitle", "step1AiIntro", "step3AiTitle", "step3AiIntro", "step3ContinueWait", "step3ContinueReady", "generateAiPlanBody", "skipAiPlanBody",
    ...
    "step4FlowTitle", "step4FlowIntro", "step2PayIntro", "step2MarketsBeforePay", "step2NoPendingWork", "step2ConfirmIntro", "step2ConfirmBeforePay", "billingAlreadyApproved", "step4PaymentBodyFirst", "step4PaymentSuccess", "step4PaymentSuccessWithMaintenance", "step4PaidIntro", "step4RestoreToContinue", "applyAlreadyDone", "unlockApply", "alreadyOptimizedTitle", "alreadyOptimizedBody",
    ...
    "priorityTitle", "priorityExplain", "rank", "product", "score", "targetScore", "loading", "loadingInline", "loadingHint", "error", "impactIntro",
    ...
    "marketsPanelTitle", "marketsPanelBody", "marketsChangeWarning", "marketsAvailableList",
    "marketsDetected", "marketsCountries", "marketsConfirmButton",
    ...
    "deliveryTitle", "deliveryIntro", "deliveryReady", "deliveryReadyLive", "deliveryNotReady", "deliveryScore",
    "deliveryRecommendTitle", "deliveryRecommendIntro", "deliveryWhyManualTheme",
    "deliveryImpactReady", "deliveryImpactNotReady",
    ...
    "deliveryOpenTheme", "deliveryRecheck", "deliveryRecheckNow", "deliveryRechecking",
