...
const MESSAGES = {
  en: {
    ...
    selectionFullCatalog: "Full catalog — all {{total}} active products included (under {{limit}} limit)",
  ...
  es: {
    ...
    selectionFullCatalog: "Catálogo completo — los {{total}} productos activos (bajo el límite de {{limit}})",
  ...
  fr: {
    ...
    selectionFullCatalog: "Catalogue complet — les {{total}} produits actifs (sous la limite de {{limit}})",
